...
for var in -v -c  -n -h -l -o
do
  for var2 in -v -c  -n -h -l -o
  do
      for var3 in -v -c  -n -h -l -o
      do
        if [ $var != $var2 ] && [ $var2 != $var3 ] && [ $var != $var3 ]
        then
          TEST1="for s21_grep.c test.txt Makefile $var $var2 $var3"
          echo "$TEST1"
          ...
          TEST3="-e for -e ^int s21_grep.c test.txt Makefile $var $var2 $var3"
          echo "$TEST3"
          ...
          TEST5="-e for -e ^print s21_grep.c $var $var2 $var3 -f pattern.txt"
          echo "$TEST5"
