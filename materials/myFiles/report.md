...
<https://repos.21-school.ru/help/ci/yaml/README.md>

[Как удалить/отменить регистрацию бегуна GitLab](https://stackoverflow.com/questions/66616014/how-do-i-delete-unregister-a-gitlab-runner)
 ...
 * [удалить gitlab-runner](https://stackoverflow.com/questions/61983155/how-to-remove-uninstall-gitlab-runner-completely-from-centos)
...
* [guide](https://rainy-gazelle-0e5.notion.site/N5-CI-CD-199c413801ae4b3f84a22ba09b190fda)

* `scp $PWD/test.o 192.168.100.10:/home/violator`

* [Как использовать команду SCP в UNIX без пароля](https://www.dmosk.ru/miniinstruktions.php?mini=scp-without-password) 
...
```
gitlab-runner@ubuntu:/home/violator$ history
1  sudo visudo
2  exit
3  ls
4  scp ./test1  violator@192.168.100.10:/home/violator/test
5  scp ./test1  violator@192.168.100.10:/home/violator/test
6  ssh-copy-id 192.168.100.10
7  ping -c 3 192.168.10
8  ssh-copy-id violator@192.168.100.10
9  ssh-copy-id ubuntu@192.168.100.10
10  ssh-copy-id violator@192.168.100.10/16
11  exit
12  ls
13  ls
14  scp ./test1 192.168.100.10:/home/violator/test
15  exit
16  exit
17  ip a
18  exit
...
22  ssh-keygen -t rsa
23  ls
24  ssh-copy-id violator@192.168.100.10
25  history
gitlab-runner@ubuntu:/home/violator$
```
